(function ($, undefined) {
        ...
        preset = function (inst) {
           ...
           // debugger;
            ...
            var i,
                ...
                ampm = tord.match(/a/i),
                hampm = tord.match(/h/),
                hformat = p == 'datetime' ? s.dateFormat + s.separator + s.timeFormat : p == 'time' ? s.timeFormat :p=="mytest"?"mm-dd:HH": s.dateFormat,
                defd = new Date(),
                stepH = s.stepHour,
                stepM = s.stepMinute,
                stepS = s.stepSecond,
            ...
            function get(d, i, def) {
               ...
               /* if(inst.optionInput&&inst.optionInput.defaultDate){
                 return  f[i](inst.optionInput.defaultDate);
                }*/
                return f[i](defd);
              //  return ;
            }
            ...
            function getArray(d) {
                ...
                for (i in o) {
                    /*if(inst.optionInput&&inst.optionInput.defaultDate){
                        ret[o[i]]=f[i](inst.optionInput.defaultDate);
                    }else{
            ...
            return {
                ...
                validate: function (dw, i, time, dir) {
                    ...
                    if(!inst.one){
                        inst.one=true;
                        validated=getClosestValidDate(inst.optionInput&&inst.optionInput.defaultDate?inst.optionInput.defaultDate: getDate(inst.getArrayVal(true)), dir);
                    }

                        var temp = getArray(validated),
                        y = get(temp, 'y'),
                        m = get(temp, 'm'),
                        minprop = true,
                        maxprop = true;
    ...
    $.each(['date', 'time', 'datetime',"mytest"], function (i, v) {
